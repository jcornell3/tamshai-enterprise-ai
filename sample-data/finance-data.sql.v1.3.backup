...
INSERT INTO fiscal_years (year, start_date, end_date, status) VALUES
...
INSERT INTO budget_categories (name, code, type, description) VALUES
...
INSERT INTO department_budgets (department_code, fiscal_year, category_id, budgeted_amount, actual_amount, forecast_amount) 
SELECT 'EXEC', 2024, id, 500000, 425000, 510000 FROM budget_categories WHERE code = 'EXP-SAL'
ON CONFLICT DO NOTHING;

INSERT INTO department_budgets (department_code, fiscal_year, category_id, budgeted_amount, actual_amount, forecast_amount) 
SELECT 'HR', 2024, id, 750000, 680000, 740000 FROM budget_categories WHERE code = 'EXP-SAL'
ON CONFLICT DO NOTHING;

INSERT INTO department_budgets (department_code, fiscal_year, category_id, budgeted_amount, actual_amount, forecast_amount) 
SELECT 'FIN', 2024, id, 450000, 410000, 455000 FROM budget_categories WHERE code = 'EXP-SAL'
ON CONFLICT DO NOTHING;

INSERT INTO department_budgets (department_code, fiscal_year, category_id, budgeted_amount, actual_amount, forecast_amount) 
SELECT 'SALES', 2024, id, 1200000, 1050000, 1180000 FROM budget_categories WHERE code = 'EXP-SAL'
ON CONFLICT DO NOTHING;

INSERT INTO department_budgets (department_code, fiscal_year, category_id, budgeted_amount, actual_amount, forecast_amount) 
SELECT 'ENG', 2024, id, 2500000, 2200000, 2480000 FROM budget_categories WHERE code = 'EXP-SAL'
ON CONFLICT DO NOTHING;

INSERT INTO department_budgets (department_code, fiscal_year, category_id, budgeted_amount, actual_amount, forecast_amount) 
SELECT 'MKT', 2024, id, 800000, 720000, 850000 FROM budget_categories WHERE code = 'EXP-MKT'
ON CONFLICT DO NOTHING;

INSERT INTO department_budgets (department_code, fiscal_year, category_id, budgeted_amount, actual_amount, forecast_amount) 
SELECT 'IT', 2024, id, 600000, 520000, 580000 FROM budget_categories WHERE code = 'EXP-TECH'
ON CONFLICT DO NOTHING;
...
INSERT INTO financial_reports (report_type, fiscal_year, period, title, description, document_path, status, is_confidential, created_by, published_at) VALUES
...
INSERT INTO invoices (invoice_number, vendor_name, vendor_id, description, amount, invoice_date, due_date, paid_date, status, department_code) VALUES
...
INSERT INTO revenue_summary (fiscal_year, quarter, category_id, amount, growth_percentage, notes)
SELECT 2024, 'Q1', id, 2500000, 12.5, 'Strong product sales' FROM budget_categories WHERE code = 'REV-PROD'
ON CONFLICT DO NOTHING;

INSERT INTO revenue_summary (fiscal_year, quarter, category_id, amount, growth_percentage, notes)
SELECT 2024, 'Q1', id, 1800000, 18.2, 'New enterprise contracts' FROM budget_categories WHERE code = 'REV-SUB'
ON CONFLICT DO NOTHING;

INSERT INTO revenue_summary (fiscal_year, quarter, category_id, amount, growth_percentage, notes)
SELECT 2024, 'Q2', id, 2750000, 10.0, 'Continued growth' FROM budget_categories WHERE code = 'REV-PROD'
ON CONFLICT DO NOTHING;

INSERT INTO revenue_summary (fiscal_year, quarter, category_id, amount, growth_percentage, notes)
SELECT 2024, 'Q2', id, 2100000, 16.7, 'Low churn rate' FROM budget_categories WHERE code = 'REV-SUB'
ON CONFLICT DO NOTHING;

INSERT INTO revenue_summary (fiscal_year, quarter, category_id, amount, growth_percentage, notes)
SELECT 2024, 'Q3', id, 2900000, 5.5, 'Seasonal slowdown' FROM budget_categories WHERE code = 'REV-PROD'
ON CONFLICT DO NOTHING;

INSERT INTO revenue_summary (fiscal_year, quarter, category_id, amount, growth_percentage, notes)
SELECT 2024, 'Q3', id, 2400000, 14.3, 'Strong retention' FROM budget_categories WHERE code = 'REV-SUB'
ON CONFLICT DO NOTHING;
...
JOIN fiscal_years fy ON db.fiscal_year = fy.year
JOIN budget_categories bc ON db.category_id = bc.id
...
JOIN budget_categories bc ON rs.category_id = bc.id
...
-- INDEXES
-- =============================================================================
CREATE INDEX IF NOT EXISTS idx_budgets_dept_year ON department_budgets(department_code, fiscal_year);
CREATE INDEX IF NOT EXISTS idx_invoices_status ON invoices(status);
CREATE INDEX IF NOT EXISTS idx_invoices_vendor ON invoices(vendor_name);
CREATE INDEX IF NOT EXISTS idx_reports_type_year ON financial_reports(report_type, fiscal_year);
