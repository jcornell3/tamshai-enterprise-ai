// Tamshai Corp Support Sample Data
// MongoDB initialization script
// Converted from Elasticsearch NDJSON format (January 8, 2026)
...
db.knowledge_base.insertMany([
  {
    kb_id: "KB-001",
    title: "How to set up TOTP (Two-Factor Authentication)",
    content: "To enable TOTP for your Tamshai account:\n1. Login to Keycloak at http://auth.tamshai.local\n2. Click Account Console\n3. Navigate to Account Security > Two-Factor Authentication\n4. Click Configure Authenticator\n5. Scan QR code with authenticator app (Google Authenticator, Authy, 1Password)\n6. Enter 6-digit code to verify\n\nRequired for all users as of Jan 1, 2026.",
    category: "security",
    tags: ["totp", "mfa", "authentication", "setup"],
    created_at: new Date("2025-12-20T10:00:00Z"),
    updated_at: new Date("2025-12-28T15:00:00Z"),
    views: 247,
    helpful_count: 32
  },
  {
    kb_id: "KB-002",
    title: "Understanding AI response truncation warnings",
    content: "If you see 'TRUNCATION WARNING: Only 50 of 50+ records returned', the AI was limited to viewing the first 50 results from the database.\n\nTo get complete results:\n1. Refine your query to be more specific (filter by department, date range, etc.)\n2. Ask the AI to paginate through results (e.g., 'Show next 50 employees')\n3. Request a data export via Support ticket for large datasets\n\nThis limit prevents timeouts and ensures fast AI responses.",
    category: "ai-usage",
    tags: ["ai", "pagination", "limits", "truncation"],
    created_at: new Date("2025-12-29T11:00:00Z"),
    updated_at: new Date("2025-12-29T11:00:00Z"),
    views: 89,
    helpful_count: 12
  },
  {
    kb_id: "KB-003",
    title: "Role-Based Access Control (RBAC) Explained",
    content: "Tamshai uses hierarchical roles to control data access:\n\nExecutive: Full read access to all departments\nDepartment Leads (hr-write, finance-write, etc.): Read/write access to their department\nDepartment Users (hr-read, finance-read, etc.): Read-only access to their department\nManagers: Access to direct reports only\nEmployees: Access to own data only\nInterns: Minimal access\n\nTo request role changes, submit a Support ticket with business justification.",
    category: "security",
    tags: ["rbac", "roles", "permissions", "access-control"],
    created_at: new Date("2025-12-15T09:00:00Z"),
    updated_at: new Date("2025-12-22T14:30:00Z"),
    views: 512,
    helpful_count: 67
  },
  {
    kb_id: "KB-004",
    title: "TamshaiAI Desktop App Installation",
    content: "Windows Installation:\n1. Download TamshaiAI-Setup-1.0.0.exe from internal portal\n2. Run installer (requires admin rights)\n3. Launch app from Start Menu\n4. Login with corporate credentials (username@tamshai.local)\n5. Complete TOTP setup if prompted\n\nSystem Requirements:\n- Windows 10 (1809+) or Windows 11\n- 4GB RAM minimum (8GB recommended)\n- 500MB disk space\n- Internet connection for AI queries",
    category: "getting-started",
    tags: ["desktop-app", "installation", "windows", "setup"],
    created_at: new Date("2025-12-10T10:00:00Z"),
    updated_at: new Date("2025-12-28T16:00:00Z"),
    views: 623,
    helpful_count: 89
  },
  {
    kb_id: "KB-005",
    title: "How to query HR data with AI",
    content: "Example HR queries:\n- 'How many employees are in Engineering?'\n- 'List all managers in the Sales department'\n- 'Show me employees hired in the last 6 months'\n- 'What is the average salary in Finance?' (requires hr-write role)\n\nTips:\n- Be specific to reduce truncation (e.g., filter by department)\n- HR-read role can see employee names, departments, titles\n- HR-write role can see salaries, performance reviews\n- Managers can only see their direct reports",
    category: "ai-usage",
    tags: ["ai", "hr", "queries", "examples"],
    created_at: new Date("2025-12-18T13:00:00Z"),
    updated_at: new Date("2025-12-28T10:00:00Z"),
    views: 341,
    helpful_count: 45
  }
]);
...
db.knowledge_base.createIndex({ "kb_id": 1 }, { unique: true });
...
print("Support data initialized successfully!");
