...
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e9f0a1b2-3c4d-5e6f-7a8b-9c0d1e2f3a4b', 'EMP001', 'Eve', 'Thompson', 'eve@tamshai.com', 'eve@tamshai.com', '+1-555-100-0001', 'd1000000-0000-0000-0000-000000000001', NULL, 'Chief Executive Officer', 'L9', '2018-01-15', 450000.00, 50, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- LEVEL 2: C-Suite (reports to CEO)
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000002', 'EMP002', 'Michael', 'Roberts', 'michael.r@tamshai.com', 'michael.r@tamshai.com', '+1-555-100-0002', 'd1000000-0000-0000-0000-000000000001', 'e9f0a1b2-3c4d-5e6f-7a8b-9c0d1e2f3a4b', 'Chief Financial Officer', 'L9', '2018-03-01', 380000.00, 45, 'Seattle, WA', true),
    ('e1000000-0000-0000-0000-000000000003', 'EMP003', 'Sarah', 'Kim', 'sarah.k@tamshai.com', 'sarah.k@tamshai.com', '+1-555-100-0003', 'd1000000-0000-0000-0000-000000000001', 'e9f0a1b2-3c4d-5e6f-7a8b-9c0d1e2f3a4b', 'Chief Technology Officer', 'L9', '2018-02-15', 395000.00, 45, 'Seattle, WA', true),
    ('e1000000-0000-0000-0000-000000000004', 'EMP004', 'James', 'Wilson', 'james.w@tamshai.com', 'james.w@tamshai.com', '+1-555-100-0004', 'd1000000-0000-0000-0000-000000000001', 'e9f0a1b2-3c4d-5e6f-7a8b-9c0d1e2f3a4b', 'Chief Operating Officer', 'L9', '2018-06-01', 360000.00, 45, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;
...
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('f104eddc-21ab-457c-a254-78051ad7ad67', 'EMP010', 'Alice', 'Chen', 'alice@tamshai.com', 'alice@tamshai.com', '+1-555-200-0001', 'd1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000004', 'VP of Human Resources', 'L8', '2019-02-01', 185000.00, 30, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- Finance Department - Reports to CFO (Michael Roberts)
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('1e8f62b4-37a5-4e67-bb91-45d1e9e3a0f1', 'EMP020', 'Bob', 'Martinez', 'bob@tamshai.com', 'bob@tamshai.com', '+1-555-300-0001', 'd1000000-0000-0000-0000-000000000003', 'e1000000-0000-0000-0000-000000000002', 'Finance Director', 'L7', '2019-04-01', 165000.00, 25, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- Sales Department - Reports to CEO (Eve Thompson)
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('c0e1c8a4-5d6e-4f9b-8a3c-7e2d1f0b9a8c', 'EMP030', 'Carol', 'Johnson', 'carol@tamshai.com', 'carol@tamshai.com', '+1-555-400-0001', 'd1000000-0000-0000-0000-000000000004', 'e9f0a1b2-3c4d-5e6f-7a8b-9c0d1e2f3a4b', 'VP of Sales', 'L8', '2019-01-15', 195000.00, 40, 'San Francisco, CA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- Support Department - Reports to COO (James Wilson)
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('d7f8e9c0-2a3b-4c5d-9e1f-8a7b6c5d4e3f', 'EMP040', 'Dan', 'Williams', 'dan@tamshai.com', 'dan@tamshai.com', '+1-555-500-0001', 'd1000000-0000-0000-0000-000000000005', 'e1000000-0000-0000-0000-000000000004', 'Support Director', 'L7', '2020-01-01', 145000.00, 20, 'Austin, TX', true)
ON CONFLICT (employee_number) DO NOTHING;

-- Engineering Department - Reports to CTO (Sarah Kim)
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000050', 'EMP050', 'Alex', 'Turner', 'alex.t@tamshai.com', 'alex.t@tamshai.com', '+1-555-600-0001', 'd1000000-0000-0000-0000-000000000006', 'e1000000-0000-0000-0000-000000000003', 'Engineering Director', 'L7', '2019-03-01', 210000.00, 25, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- IT Department - Reports to CTO (Sarah Kim)
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000060', 'EMP060', 'Brian', 'Adams', 'brian.a@tamshai.com', 'brian.a@tamshai.com', '+1-555-700-0001', 'd1000000-0000-0000-0000-000000000010', 'e1000000-0000-0000-0000-000000000003', 'IT Manager', 'L5', '2019-05-01', 130000.00, 15, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;
...
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000011', 'EMP011', 'Jennifer', 'Lee', 'jennifer.l@tamshai.com', 'jennifer.l@tamshai.com', '+1-555-200-0002', 'd1000000-0000-0000-0000-000000000002', 'f104eddc-21ab-457c-a254-78051ad7ad67', 'HR Manager', 'L5', '2020-03-15', 95000.00, 15, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- Finance Team - Reports to Bob Martinez
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000021', 'EMP021', 'Lisa', 'Anderson', 'lisa.a@tamshai.com', 'lisa.a@tamshai.com', '+1-555-300-0002', 'd1000000-0000-0000-0000-000000000003', '1e8f62b4-37a5-4e67-bb91-45d1e9e3a0f1', 'Senior Accountant', 'L4', '2020-01-15', 92000.00, 10, 'Seattle, WA', false)
ON CONFLICT (employee_number) DO NOTHING;

-- Sales Team - Reports to Carol Johnson
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000031', 'EMP031', 'Ryan', 'Garcia', 'ryan.g@tamshai.com', 'ryan.g@tamshai.com', '+1-555-400-0002', 'd1000000-0000-0000-0000-000000000004', 'c0e1c8a4-5d6e-4f9b-8a3c-7e2d1f0b9a8c', 'Sales Manager', 'L5', '2020-02-01', 125000.00, 30, 'San Francisco, CA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- Support Team - Reports to Dan Williams
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000041', 'EMP041', 'Emily', 'Clark', 'emily.c@tamshai.com', 'emily.c@tamshai.com', '+1-555-500-0002', 'd1000000-0000-0000-0000-000000000005', 'd7f8e9c0-2a3b-4c5d-9e1f-8a7b6c5d4e3f', 'Senior Support Engineer', 'L4', '2020-06-15', 78000.00, 10, 'Austin, TX', false)
ON CONFLICT (employee_number) DO NOTHING;

-- Engineering Team - Reports to Alex Turner
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('a5b6c7d8-9e0f-1a2b-3c4d-5e6f7a8b9c0d', 'EMP051', 'Nina', 'Patel', 'nina.p@tamshai.com', 'nina.p@tamshai.com', '+1-555-600-0002', 'd1000000-0000-0000-0000-000000000006', 'e1000000-0000-0000-0000-000000000050', 'Engineering Manager', 'L5', '2019-08-15', 175000.00, 20, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;
...
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000032', 'EMP032', 'Amanda', 'White', 'amanda.w@tamshai.com', 'amanda.w@tamshai.com', '+1-555-400-0003', 'd1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000031', 'Account Executive', 'L4', '2021-03-15', 85000.00, 25, 'New York, NY', false),
    ('e1000000-0000-0000-0000-000000000033', 'EMP033', 'Chris', 'Taylor', 'chris.t@tamshai.com', 'chris.t@tamshai.com', '+1-555-400-0004', 'd1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000031', 'Account Executive', 'L4', '2021-05-01', 82000.00, 25, 'Chicago, IL', false),
    ('e1000000-0000-0000-0000-000000000034', 'EMP034', 'Michelle', 'Davis', 'michelle.d@tamshai.com', 'michelle.d@tamshai.com', '+1-555-400-0005', 'd1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000031', 'Sales Development Rep', 'L2', '2022-01-10', 65000.00, 20, 'Remote', false)
ON CONFLICT (employee_number) DO NOTHING;

-- Support ICs - Reports to Dan Williams
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000042', 'EMP042', 'Jason', 'Miller', 'jason.m@tamshai.com', 'jason.m@tamshai.com', '+1-555-500-0003', 'd1000000-0000-0000-0000-000000000005', 'd7f8e9c0-2a3b-4c5d-9e1f-8a7b6c5d4e3f', 'Support Engineer', 'L3', '2021-09-01', 68000.00, 10, 'Remote', false),
    ('e1000000-0000-0000-0000-000000000043', 'EMP043', 'Rachel', 'Moore', 'rachel.m@tamshai.com', 'rachel.m@tamshai.com', '+1-555-500-0004', 'd1000000-0000-0000-0000-000000000005', 'd7f8e9c0-2a3b-4c5d-9e1f-8a7b6c5d4e3f', 'Support Engineer', 'L3', '2022-02-15', 65000.00, 10, 'Remote', false)
ON CONFLICT (employee_number) DO NOTHING;

-- Engineering ICs - Reports to Nina Patel
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000052', 'EMP052', 'Marcus', 'Johnson', 'marcus.j@tamshai.com', 'marcus.j@tamshai.com', '+1-555-600-0003', 'd1000000-0000-0000-0000-000000000006', 'a5b6c7d8-9e0f-1a2b-3c4d-5e6f7a8b9c0d', 'Software Engineer', 'L4', '2020-11-01', 145000.00, 15, 'Seattle, WA', false),
    ('e1000000-0000-0000-0000-000000000053', 'EMP053', 'Sophia', 'Wang', 'sophia.w@tamshai.com', 'sophia.w@tamshai.com', '+1-555-600-0004', 'd1000000-0000-0000-0000-000000000006', 'a5b6c7d8-9e0f-1a2b-3c4d-5e6f7a8b9c0d', 'Software Engineer', 'L4', '2021-02-15', 140000.00, 15, 'Remote', false),
    ('e1000000-0000-0000-0000-000000000054', 'EMP054', 'Tyler', 'Scott', 'tyler.s@tamshai.com', 'tyler.s@tamshai.com', '+1-555-600-0005', 'd1000000-0000-0000-0000-000000000006', 'a5b6c7d8-9e0f-1a2b-3c4d-5e6f7a8b9c0d', 'Junior Software Engineer', 'L2', '2022-06-01', 95000.00, 10, 'Seattle, WA', false)
ON CONFLICT (employee_number) DO NOTHING;
...
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000070', 'EMP070', 'Patricia', 'Morgan', 'patricia.m@tamshai.com', 'patricia.m@tamshai.com', '+1-555-800-0001', 'd1000000-0000-0000-0000-000000000007', 'e9f0a1b2-3c4d-5e6f-7a8b-9c0d1e2f3a4b', 'VP of Marketing', 'L8', '2019-07-01', 190000.00, 30, 'San Francisco, CA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- Marketing Team - Reports to Patricia Morgan
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000071', 'EMP071', 'Steven', 'Harris', 'steven.h@tamshai.com', 'steven.h@tamshai.com', '+1-555-800-0002', 'd1000000-0000-0000-0000-000000000007', 'e1000000-0000-0000-0000-000000000070', 'Marketing Manager', 'L5', '2020-08-01', 115000.00, 20, 'San Francisco, CA', true),
    ('e1000000-0000-0000-0000-000000000072', 'EMP072', 'Linda', 'Thompson', 'linda.t@tamshai.com', 'linda.t@tamshai.com', '+1-555-800-0003', 'd1000000-0000-0000-0000-000000000007', 'e1000000-0000-0000-0000-000000000071', 'Content Strategist', 'L4', '2021-03-01', 88000.00, 15, 'Remote', false),
    ('e1000000-0000-0000-0000-000000000073', 'EMP073', 'Robert', 'Jackson', 'robert.j@tamshai.com', 'robert.j@tamshai.com', '+1-555-800-0004', 'd1000000-0000-0000-0000-000000000007', 'e1000000-0000-0000-0000-000000000071', 'Digital Marketing Specialist', 'L3', '2021-09-01', 75000.00, 10, 'New York, NY', false),
    ('e1000000-0000-0000-0000-000000000074', 'EMP074', 'Jessica', 'Lewis', 'jessica.l@tamshai.com', 'jessica.l@tamshai.com', '+1-555-800-0005', 'd1000000-0000-0000-0000-000000000007', 'e1000000-0000-0000-0000-000000000071', 'Social Media Manager', 'L3', '2022-01-15', 72000.00, 10, 'Remote', false),
    ('e1000000-0000-0000-0000-000000000075', 'EMP075', 'Andrew', 'Young', 'andrew.y@tamshai.com', 'andrew.y@tamshai.com', '+1-555-800-0006', 'd1000000-0000-0000-0000-000000000007', 'e1000000-0000-0000-0000-000000000071', 'Marketing Coordinator', 'L2', '2023-03-01', 58000.00, 5, 'San Francisco, CA', false)
ON CONFLICT (employee_number) DO NOTHING;

-- Operations Department - Reports to COO (James Wilson)
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000080', 'EMP080', 'William', 'Robinson', 'william.r@tamshai.com', 'william.r@tamshai.com', '+1-555-900-0001', 'd1000000-0000-0000-0000-000000000008', 'e1000000-0000-0000-0000-000000000004', 'Operations Director', 'L7', '2019-09-01', 155000.00, 25, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- Operations Team - Reports to William Robinson
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000081', 'EMP081', 'Elizabeth', 'Hall', 'elizabeth.h@tamshai.com', 'elizabeth.h@tamshai.com', '+1-555-900-0002', 'd1000000-0000-0000-0000-000000000008', 'e1000000-0000-0000-0000-000000000080', 'Operations Manager', 'L5', '2020-04-01', 105000.00, 15, 'Seattle, WA', true),
    ('e1000000-0000-0000-0000-000000000082', 'EMP082', 'Charles', 'Allen', 'charles.a@tamshai.com', 'charles.a@tamshai.com', '+1-555-900-0003', 'd1000000-0000-0000-0000-000000000008', 'e1000000-0000-0000-0000-000000000081', 'Business Analyst', 'L4', '2021-06-01', 85000.00, 10, 'Remote', false),
    ('e1000000-0000-0000-0000-000000000083', 'EMP083', 'Dorothy', 'King', 'dorothy.k@tamshai.com', 'dorothy.k@tamshai.com', '+1-555-900-0004', 'd1000000-0000-0000-0000-000000000008', 'e1000000-0000-0000-0000-000000000081', 'Project Coordinator', 'L3', '2022-02-01', 68000.00, 10, 'Seattle, WA', false),
    ('e1000000-0000-0000-0000-000000000084', 'EMP084', 'Daniel', 'Wright', 'daniel.w@tamshai.com', 'daniel.w@tamshai.com', '+1-555-900-0005', 'd1000000-0000-0000-0000-000000000008', 'e1000000-0000-0000-0000-000000000081', 'Operations Associate', 'L2', '2023-01-15', 55000.00, 5, 'Seattle, WA', false)
ON CONFLICT (employee_number) DO NOTHING;

-- Legal Department - Reports to CEO (Eve Thompson)
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000090', 'EMP090', 'Margaret', 'Scott', 'margaret.s@tamshai.com', 'margaret.s@tamshai.com', '+1-555-950-0001', 'd1000000-0000-0000-0000-000000000009', 'e9f0a1b2-3c4d-5e6f-7a8b-9c0d1e2f3a4b', 'General Counsel', 'L8', '2019-04-01', 220000.00, 30, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- Legal Team - Reports to Margaret Scott
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000091', 'EMP091', 'Joseph', 'Green', 'joseph.g@tamshai.com', 'joseph.g@tamshai.com', '+1-555-950-0002', 'd1000000-0000-0000-0000-000000000009', 'e1000000-0000-0000-0000-000000000090', 'Corporate Counsel', 'L6', '2020-06-01', 175000.00, 20, 'Seattle, WA', false),
    ('e1000000-0000-0000-0000-000000000092', 'EMP092', 'Susan', 'Adams', 'susan.a@tamshai.com', 'susan.a@tamshai.com', '+1-555-950-0003', 'd1000000-0000-0000-0000-000000000009', 'e1000000-0000-0000-0000-000000000090', 'Legal Coordinator', 'L3', '2021-11-01', 72000.00, 10, 'Seattle, WA', false)
ON CONFLICT (employee_number) DO NOTHING;

-- Additional Engineering ICs - Reports to Nina Patel
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000055', 'EMP055', 'Benjamin', 'Carter', 'benjamin.c@tamshai.com', 'benjamin.c@tamshai.com', '+1-555-600-0006', 'd1000000-0000-0000-0000-000000000006', 'a5b6c7d8-9e0f-1a2b-3c4d-5e6f7a8b9c0d', 'Senior Software Engineer', 'L4', '2020-09-01', 155000.00, 15, 'Seattle, WA', false),
    ('e1000000-0000-0000-0000-000000000056', 'EMP056', 'Olivia', 'Phillips', 'olivia.p@tamshai.com', 'olivia.p@tamshai.com', '+1-555-600-0007', 'd1000000-0000-0000-0000-000000000006', 'a5b6c7d8-9e0f-1a2b-3c4d-5e6f7a8b9c0d', 'Software Engineer', 'L3', '2021-07-01', 125000.00, 12, 'Remote', false),
    ('e1000000-0000-0000-0000-000000000057', 'EMP057', 'Ethan', 'Campbell', 'ethan.c@tamshai.com', 'ethan.c@tamshai.com', '+1-555-600-0008', 'd1000000-0000-0000-0000-000000000006', 'a5b6c7d8-9e0f-1a2b-3c4d-5e6f7a8b9c0d', 'QA Engineer', 'L3', '2021-10-01', 105000.00, 10, 'Seattle, WA', false),
    ('e1000000-0000-0000-0000-000000000058', 'EMP058', 'Emma', 'Mitchell', 'emma.m@tamshai.com', 'emma.m@tamshai.com', '+1-555-600-0009', 'd1000000-0000-0000-0000-000000000006', 'a5b6c7d8-9e0f-1a2b-3c4d-5e6f7a8b9c0d', 'DevOps Engineer', 'L4', '2020-12-01', 145000.00, 15, 'Remote', false),
    ('e1000000-0000-0000-0000-000000000059', 'EMP059', 'Alexander', 'Roberts', 'alexander.r@tamshai.com', 'alexander.r@tamshai.com', '+1-555-600-0010', 'd1000000-0000-0000-0000-000000000006', 'a5b6c7d8-9e0f-1a2b-3c4d-5e6f7a8b9c0d', 'Junior Developer', 'L2', '2023-06-01', 85000.00, 8, 'Seattle, WA', false),
    ('e1000000-0000-0000-0000-00000000005a', 'EMP05A', 'Isabella', 'Turner', 'isabella.t@tamshai.com', 'isabella.t@tamshai.com', '+1-555-600-0011', 'd1000000-0000-0000-0000-000000000006', 'a5b6c7d8-9e0f-1a2b-3c4d-5e6f7a8b9c0d', 'Engineering Intern', 'L1', '2024-05-15', 48000.00, 0, 'Seattle, WA', false)
ON CONFLICT (employee_number) DO NOTHING;

-- Additional Sales ICs - Reports to Ryan Garcia
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000035', 'EMP035', 'Matthew', 'Evans', 'matthew.e@tamshai.com', 'matthew.e@tamshai.com', '+1-555-400-0006', 'd1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000031', 'Account Executive', 'L4', '2021-08-01', 88000.00, 25, 'Boston, MA', false),
    ('e1000000-0000-0000-0000-000000000036', 'EMP036', 'Samantha', 'Collins', 'samantha.c@tamshai.com', 'samantha.c@tamshai.com', '+1-555-400-0007', 'd1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000031', 'Account Executive', 'L4', '2022-03-01', 82000.00, 25, 'Los Angeles, CA', false),
    ('e1000000-0000-0000-0000-000000000037', 'EMP037', 'Joshua', 'Stewart', 'joshua.s@tamshai.com', 'joshua.s@tamshai.com', '+1-555-400-0008', 'd1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000031', 'Sales Development Rep', 'L2', '2022-09-01', 62000.00, 20, 'Remote', false),
    ('e1000000-0000-0000-0000-000000000038', 'EMP038', 'Ashley', 'Sanchez', 'ashley.s@tamshai.com', 'ashley.s@tamshai.com', '+1-555-400-0009', 'd1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000031', 'Sales Intern', 'L1', '2024-06-15', 42000.00, 10, 'San Francisco, CA', false)
ON CONFLICT (employee_number) DO NOTHING;

-- Additional Support ICs - Reports to Dan Williams
INSERT INTO hr.employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000044', 'EMP044', 'Brandon', 'Morris', 'brandon.m@tamshai.com', 'brandon.m@tamshai.com', '+1-555-500-0005', 'd1000000-0000-0000-0000-000000000005', 'd7f8e9c0-2a3b-4c5d-9e1f-8a7b6c5d4e3f', 'Senior Support Engineer', 'L4', '2020-07-01', 82000.00, 12, 'Austin, TX', false),
    ('e1000000-0000-0000-0000-000000000045', 'EMP045', 'Kimberly', 'Rogers', 'kimberly.r@tamshai.com', 'kimberly.r@tamshai.com', '+1-555-500-0006', 'd1000000-0000-0000-0000-000000000005', 'd7f8e9c0-2a3b-4c5d-9e1f-8a7b6c5d4e3f', 'Support Engineer', 'L3', '2021-05-01', 70000.00, 10, 'Remote', false),
    ('e1000000-0000-0000-0000-000000000046', 'EMP046', 'Justin', 'Reed', 'justin.r@tamshai.com', 'justin.r@tamshai.com', '+1-555-500-0007', 'd1000000-0000-0000-0000-000000000005', 'd7f8e9c0-2a3b-4c5d-9e1f-8a7b6c5d4e3f', 'Support Associate', 'L2', '2022-08-01', 58000.00, 8, 'Remote', false),
    ('e1000000-0000-0000-0000-000000000047', 'EMP047', 'Stephanie', 'Cook', 'stephanie.c@tamshai.com', 'stephanie.c@tamshai.com', '+1-555-500-0008', 'd1000000-0000-0000-0000-000000000005', 'd7f8e9c0-2a3b-4c5d-9e1f-8a7b6c5d4e3f', 'Customer Success Rep', 'L2', '2023-02-01', 55000.00, 8, 'Austin, TX', false)
ON CONFLICT (employee_number) DO NOTHING;
