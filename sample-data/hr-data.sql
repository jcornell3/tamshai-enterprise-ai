...
INSERT INTO hr.performance_reviews (employee_id, reviewer_id, review_period, review_date, overall_rating, goals_met_percentage, strengths, areas_for_improvement) VALUES
    ...
    ('e1000000-0000-0000-0000-000000000030', 'e1000000-0000-0000-0000-000000000001', '2024-H1', '2024-07-15', 4.8, 100, 'Exceeded sales targets, excellent team builder', 'Continue developing strategic partnerships'),
...
UPDATE hr.departments SET head_employee_id = 'e1000000-0000-0000-0000-000000000001' WHERE code = 'EXEC';
UPDATE hr.departments SET head_employee_id = 'e1000000-0000-0000-0000-000000000010' WHERE code = 'HR';
UPDATE hr.departments SET head_employee_id = 'e1000000-0000-0000-0000-000000000020' WHERE code = 'FIN';
UPDATE hr.departments SET head_employee_id = 'e1000000-0000-0000-0000-000000000030' WHERE code = 'SALES';
UPDATE hr.departments SET head_employee_id = 'e1000000-0000-0000-0000-000000000040' WHERE code = 'SUPPORT';
