...
INSERT INTO grade_levels (grade, title_prefix, min_salary, max_salary, description) VALUES
...
CREATE TABLE IF NOT EXISTS employees (
    ...
    title VARCHAR(100),
    grade VARCHAR(10) REFERENCES grade_levels(grade),
...
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000001', 'EMP001', 'Eve', 'Thompson', 'eve@tamshai.local', 'eve@tamshai.local', '+1-555-100-0001', 'd1000000-0000-0000-0000-000000000001', NULL, 'Chief Executive Officer', 'L9', '2018-01-15', 450000.00, 50, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- LEVEL 2: C-Suite (reports to CEO)
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000002', 'EMP002', 'Michael', 'Roberts', 'michael.r@tamshai.local', 'michael.r@tamshai.local', '+1-555-100-0002', 'd1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000001', 'Chief Financial Officer', 'L9', '2018-03-01', 380000.00, 45, 'Seattle, WA', true),
    ('e1000000-0000-0000-0000-000000000003', 'EMP003', 'Sarah', 'Kim', 'sarah.k@tamshai.local', 'sarah.k@tamshai.local', '+1-555-100-0003', 'd1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000001', 'Chief Technology Officer', 'L9', '2018-02-15', 395000.00, 45, 'Seattle, WA', true),
    ('e1000000-0000-0000-0000-000000000004', 'EMP004', 'James', 'Wilson', 'james.w@tamshai.local', 'james.w@tamshai.local', '+1-555-100-0004', 'd1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000001', 'Chief Operating Officer', 'L9', '2018-06-01', 360000.00, 45, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;
...
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000010', 'EMP010', 'Alice', 'Chen', 'alice@tamshai.local', 'alice@tamshai.local', '+1-555-200-0001', 'd1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000004', 'VP of Human Resources', 'L8', '2019-02-01', 185000.00, 30, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- Finance Department - Reports to CFO (Michael Roberts)
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000020', 'EMP020', 'Bob', 'Martinez', 'bob@tamshai.local', 'bob@tamshai.local', '+1-555-300-0001', 'd1000000-0000-0000-0000-000000000003', 'e1000000-0000-0000-0000-000000000002', 'Finance Director', 'L7', '2019-04-01', 165000.00, 25, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- Sales Department - Reports to CEO (Eve Thompson)
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000030', 'EMP030', 'Carol', 'Johnson', 'carol@tamshai.local', 'carol@tamshai.local', '+1-555-400-0001', 'd1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000001', 'VP of Sales', 'L8', '2019-01-15', 195000.00, 40, 'San Francisco, CA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- Support Department - Reports to COO (James Wilson)
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000040', 'EMP040', 'Dan', 'Williams', 'dan@tamshai.local', 'dan@tamshai.local', '+1-555-500-0001', 'd1000000-0000-0000-0000-000000000005', 'e1000000-0000-0000-0000-000000000004', 'Support Director', 'L7', '2020-01-01', 145000.00, 20, 'Austin, TX', true)
ON CONFLICT (employee_number) DO NOTHING;
...
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000011', 'EMP011', 'Jennifer', 'Lee', 'jennifer.l@tamshai.local', 'jennifer.l@tamshai.local', '+1-555-200-0002', 'd1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000010', 'HR Manager', 'L5', '2020-03-15', 95000.00, 15, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- Finance Team - Reports to Bob Martinez
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000021', 'EMP021', 'Lisa', 'Anderson', 'lisa.a@tamshai.local', 'lisa.a@tamshai.local', '+1-555-300-0002', 'd1000000-0000-0000-0000-000000000003', 'e1000000-0000-0000-0000-000000000020', 'Senior Accountant', 'L4', '2020-01-15', 92000.00, 10, 'Seattle, WA', false)
ON CONFLICT (employee_number) DO NOTHING;

-- Sales Team - Reports to Carol Johnson
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000031', 'EMP031', 'Ryan', 'Garcia', 'ryan.g@tamshai.local', 'ryan.g@tamshai.local', '+1-555-400-0002', 'd1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000030', 'Sales Manager', 'L5', '2020-02-01', 125000.00, 30, 'San Francisco, CA', true)
ON CONFLICT (employee_number) DO NOTHING;

-- Support Team - Reports to Dan Williams
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000041', 'EMP041', 'Emily', 'Clark', 'emily.c@tamshai.local', 'emily.c@tamshai.local', '+1-555-500-0002', 'd1000000-0000-0000-0000-000000000005', 'e1000000-0000-0000-0000-000000000040', 'Senior Support Engineer', 'L4', '2020-06-15', 78000.00, 10, 'Austin, TX', false)
ON CONFLICT (employee_number) DO NOTHING;

-- Engineering Team - Reports to Alex Turner
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000051', 'EMP051', 'Nina', 'Patel', 'nina.p@tamshai.local', 'nina.p@tamshai.local', '+1-555-600-0002', 'd1000000-0000-0000-0000-000000000006', 'e1000000-0000-0000-0000-000000000050', 'Engineering Manager', 'L5', '2019-08-15', 175000.00, 20, 'Seattle, WA', true)
ON CONFLICT (employee_number) DO NOTHING;
...
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000022', 'EMP022', 'Kevin', 'Brown', 'kevin.b@tamshai.local', 'kevin.b@tamshai.local', '+1-555-300-0003', 'd1000000-0000-0000-0000-000000000003', 'e1000000-0000-0000-0000-000000000020', 'Financial Analyst', 'L3', '2021-08-01', 78000.00, 10, 'Remote', false),
    ('e1000000-0000-0000-0000-000000000023', 'EMP023', 'Amanda', 'Wright', 'amanda.wr@tamshai.local', 'amanda.wr@tamshai.local', '+1-555-300-0004', 'd1000000-0000-0000-0000-000000000003', 'e1000000-0000-0000-0000-000000000020', 'Junior Accountant', 'L2', '2023-01-15', 62000.00, 5, 'Seattle, WA', false)
ON CONFLICT (employee_number) DO NOTHING;
...
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000042', 'EMP042', 'Jason', 'Miller', 'jason.m@tamshai.local', 'jason.m@tamshai.local', '+1-555-500-0003', 'd1000000-0000-0000-0000-000000000005', 'e1000000-0000-0000-0000-000000000040', 'Support Engineer', 'L3', '2021-09-01', 68000.00, 10, 'Remote', false),
    ('e1000000-0000-0000-0000-000000000043', 'EMP043', 'Rachel', 'Moore', 'rachel.m@tamshai.local', 'rachel.m@tamshai.local', '+1-555-500-0004', 'd1000000-0000-0000-0000-000000000005', 'e1000000-0000-0000-0000-000000000040', 'Support Engineer', 'L3', '2022-02-15', 65000.00, 10, 'Remote', false)
ON CONFLICT (employee_number) DO NOTHING;

-- Engineering ICs - Reports to Nina Patel
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000052', 'EMP052', 'Marcus', 'Johnson', 'marcus.j@tamshai.local', 'marcus.j@tamshai.local', '+1-555-600-0003', 'd1000000-0000-0000-0000-000000000006', 'e1000000-0000-0000-0000-000000000051', 'Software Engineer', 'L4', '2020-11-01', 145000.00, 15, 'Seattle, WA', false),
    ('e1000000-0000-0000-0000-000000000053', 'EMP053', 'Sophia', 'Wang', 'sophia.w@tamshai.local', 'sophia.w@tamshai.local', '+1-555-600-0004', 'd1000000-0000-0000-0000-000000000006', 'e1000000-0000-0000-0000-000000000051', 'Software Engineer', 'L4', '2021-02-15', 140000.00, 15, 'Remote', false),
    ('e1000000-0000-0000-0000-000000000054', 'EMP054', 'Tyler', 'Scott', 'tyler.s@tamshai.local', 'tyler.s@tamshai.local', '+1-555-600-0005', 'd1000000-0000-0000-0000-000000000006', 'e1000000-0000-0000-0000-000000000051', 'Junior Software Engineer', 'L2', '2022-06-01', 95000.00, 10, 'Seattle, WA', false)
ON CONFLICT (employee_number) DO NOTHING;

-- IT ICs - Reports to Brian Adams (including the intern Frank)
INSERT INTO employees (id, employee_number, first_name, last_name, email, work_email, phone, department_id, manager_id, title, grade, hire_date, salary, bonus_target_pct, location, is_manager) VALUES
    ('e1000000-0000-0000-0000-000000000061', 'EMP061', 'Frank', 'Davis', 'frank@tamshai.local', 'frank@tamshai.local', '+1-555-700-0002', 'd1000000-0000-0000-0000-000000000010', 'e1000000-0000-0000-0000-000000000060', 'IT Intern', 'L1', '2024-06-01', 45000.00, 0, 'Seattle, WA', false),
...
INSERT INTO performance_reviews (employee_id, reviewer_id, review_period, review_date, overall_rating, goals_met_percentage, strengths, areas_for_improvement) VALUES
    ('e1000000-0000-0000-0000-000000000010', 'e1000000-0000-0000-0000-000000000004', '2024-H1', '2024-07-15', 4.5, 95, 'Excellent leadership, strong employee relations', 'Could delegate more effectively'),
    ('e1000000-0000-0000-0000-000000000020', 'e1000000-0000-0000-0000-000000000002', '2024-H1', '2024-07-15', 4.2, 90, 'Strong financial acumen, detail-oriented', 'Improve cross-department communication'),
    ('e1000000-0000-0000-0000-000000000030', 'e1000000-0000-0000-0000-000000000001', '2024-H1', '2024-07-15', 4.8, 110, 'Exceeded sales targets, excellent team builder', 'Continue developing strategic partnerships'),
    ('e1000000-0000-0000-0000-000000000040', 'e1000000-0000-0000-0000-000000000004', '2024-H1', '2024-07-15', 4.0, 88, 'Great customer satisfaction scores', 'Reduce average ticket resolution time'),
    ('e1000000-0000-0000-0000-000000000051', 'e1000000-0000-0000-0000-000000000050', '2024-H1', '2024-07-15', 4.3, 92, 'Strong technical skills, great mentor', 'Improve documentation practices'),
    ('e1000000-0000-0000-0000-000000000052', 'e1000000-0000-0000-0000-000000000051', '2024-H1', '2024-07-15', 3.8, 85, 'Solid coding skills, reliable', 'Take on more leadership responsibilities')
...
BEGIN
    ...
    WHERE e.manager_id = (SELECT id FROM employees WHERE work_email = manager_email)
    AND e.status = 'ACTIVE';
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    WITH RECURSIVE management_chain AS (
        SELECT id, manager_id FROM employees WHERE work_email = employee_email
        UNION ALL
    ...
    SELECT EXISTS (
        ...
        JOIN employees m ON mc.manager_id = m.id
...
LEFT JOIN departments d ON e.department_id = d.id
LEFT JOIN employees m ON e.manager_id = m.id
LEFT JOIN grade_levels g ON e.grade = g.grade;
...
UPDATE departments SET head_employee_id = 'e1000000-0000-0000-0000-000000000001' WHERE code = 'EXEC';
UPDATE departments SET head_employee_id = 'e1000000-0000-0000-0000-000000000010' WHERE code = 'HR';
UPDATE departments SET head_employee_id = 'e1000000-0000-0000-0000-000000000020' WHERE code = 'FIN';
UPDATE departments SET head_employee_id = 'e1000000-0000-0000-0000-000000000030' WHERE code = 'SALES';
UPDATE departments SET head_employee_id = 'e1000000-0000-0000-0000-000000000040' WHERE code = 'SUPPORT';
UPDATE departments SET head_employee_id = 'e1000000-0000-0000-0000-000000000050' WHERE code = 'ENG';
UPDATE departments SET head_employee_id = 'e1000000-0000-0000-0000-000000000060' WHERE code = 'IT';
...
CREATE POLICY employee_hr_access ON employees
    FOR SELECT
    USING (
...
CREATE POLICY employee_executive_access ON employees
    FOR SELECT
    USING (
...
CREATE POLICY employee_manager_access ON employees
    FOR SELECT
    USING (
...
CREATE POLICY review_self_access ON performance_reviews
    FOR SELECT
    USING (
        employee_id IN (
...
CREATE POLICY review_hr_access ON performance_reviews
    FOR SELECT
    USING (
        current_setting('app.current_user_roles', true) LIKE '%hr-read%'
        OR current_setting('app.current_user_roles', true) LIKE '%hr-write%'
...
CREATE POLICY review_manager_access ON performance_reviews
    FOR SELECT
    USING (
        current_setting('app.current_user_roles', true) LIKE '%manager%'
        AND employee_id IN (
...
CREATE RULE audit_no_update AS ON UPDATE TO access_audit_log DO INSTEAD NOTHING;
CREATE RULE audit_no_delete AS ON DELETE TO access_audit_log DO INSTEAD NOTHING;

-- Index for efficient audit queries
CREATE INDEX IF NOT EXISTS idx_audit_timestamp ON access_audit_log(timestamp);
CREATE INDEX IF NOT EXISTS idx_audit_user ON access_audit_log(user_email);
CREATE INDEX IF NOT EXISTS idx_audit_decision ON access_audit_log(access_decision);
CREATE INDEX IF NOT EXISTS idx_audit_request ON access_audit_log(request_id);
