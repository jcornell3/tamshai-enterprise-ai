...
module "security" {
  ...
  # Bug #32 Fix: Always enable - each region needs its own provision-users job.
  # The job image is built for each region during deployment (Phase 1.5 in evacuate-region.sh).
