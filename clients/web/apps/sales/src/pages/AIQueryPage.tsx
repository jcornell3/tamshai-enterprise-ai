 ...
 *
 * Natural language queries to Sales data using SSE streaming (Architecture v1.5)
 *
 * Features:
 * - Server-Sent Events (SSE) for streaming responses
 * - Display directive detection (display:sales:customer:customerId={id}, etc.)
...
export default function AIQueryPage() {
   ...
   * Example: display:sales:customer:customerId=123
   */
  const detectDirective = (text: string): string | null => {
    const directiveRegex = /display:sales:(\w+):([^\s]*)/;
    ...
    <div className="page-container">
      <div className="page-header">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="page-title">AI-Powered Sales Query</h2>
            <p className="page-subtitle">
              Ask natural language questions about CRM and opportunities with SSE streaming
            </p>
          </div>
          {/* Voice Output Toggle */}
      ...
      <div className="alert-info mb-6">
        ...
        <p className="text-sm">
          ...
          Try: "Show customer details" for interactive visualizations.
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex gap-3">
            <input
              ...
              placeholder="e.g., List all open opportunities"
      ...
      <div className="card bg-secondary-50">
        ...
        <ul className="space-y-2 text-sm text-secondary-700">
          <li className="flex items-start gap-2">
            ...
            <span>
              <strong>Pipeline stages:</strong> LEAD, QUALIFIED, PROPOSAL, NEGOTIATION, CLOSED_WON, CLOSED_LOST
            </span>
          </li>
          <li className="flex items-start gap-2">
            <svg
