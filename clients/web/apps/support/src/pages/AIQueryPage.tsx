 ...
 *
 * Natural language queries to Support data using SSE streaming (Architecture v1.5)
 *
 * Features:
 * - Server-Sent Events (SSE) for streaming responses
 * - Display directive detection (display:support:tickets:status=open, etc.)
...
export default function AIQueryPage() {
  ...
  const exampleQueries = [
    ...
    'Find tickets related to login issues',
   ...
   * Example: display:support:tickets:status=open,priority=high
   */
  const detectDirective = (text: string): string | null => {
    const directiveRegex = /display:support:(\w+):([^\s]*)/;
    ...
    <div className="page-container">
      <div className="page-header">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="page-title">AI-Powered Support Query</h2>
            <p className="page-subtitle">
              Ask natural language questions about tickets and knowledge base with SSE streaming
            </p>
          </div>
          {/* Voice Output Toggle */}
      ...
      <div className="alert-info mb-6">
        ...
        <p className="text-sm">
          ...
          Try: "Show critical tickets" for interactive visualizations.
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex gap-3">
            <input
              ...
              placeholder="e.g., Search for open high-priority tickets"
      ...
      <div className="card bg-secondary-50">
        ...
        <ul className="space-y-2 text-sm text-secondary-700">
          <li className="flex items-start gap-2">
            ...
            <span>
              <strong>Ticket statuses:</strong> open, in_progress, resolved, closed
            </span>
          </li>
          <li className="flex items-start gap-2">
            <svg
            ...
            <span>
              <strong>Priorities:</strong> low, medium, high, critical
            </span>
          </li>
          <li className="flex items-start gap-2">
            <svg
