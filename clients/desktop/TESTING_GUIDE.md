...
3. **TOTP Requirement**: All test users require TOTP (use secret: `JBSWY3DPEHPK3PXP`)
...
|----------|----------|-------|--------------|
| alice.chen | password123 | hr-read, hr-write, manager | Department Admin |
| bob.martinez | password123 | finance-read, finance-write | Department Admin |
| carol.johnson | password123 | sales-read, sales-write | Department Admin |
| dan.williams | password123 | support-read, support-write | Department Admin |
| eve.thompson | password123 | executive | Executive |
| nina.patel | password123 | manager | Manager |
| marcus.johnson | password123 | user | User |
| frank.davis | password123 | intern | User |

**TOTP Secret for all users**: `JBSWY3DPEHPK3PXP`
