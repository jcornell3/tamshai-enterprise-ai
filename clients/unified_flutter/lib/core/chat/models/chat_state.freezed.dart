...
class _$PendingConfirmationImpl implements _PendingConfirmation {
  ...
  int get hashCode => Object.hash(
    ...
    message,
    action,
    const DeepCollectionEquality().hash(_confirmationData),
    isExpired,
  );
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$PendingConfirmationImplToJson(this);
  }
}
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(
                  other.currentStreamingMessageId,
...
abstract class _$$SSEChunkImplCopyWith<$Res>
  ...
  factory _$$SSEChunkImplCopyWith(
    _$SSEChunkImpl value,
    $Res Function(_$SSEChunkImpl) then,
...
class __$$SSEChunkImplCopyWithImpl<$Res>
  ...
  __$$SSEChunkImplCopyWithImpl(
    _$SSEChunkImpl _value,
    $Res Function(_$SSEChunkImpl) _then,
  ) : super(_value, _then);
...
class _$SSEChunkImpl implements _SSEChunk {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$SSEChunkImplToJson(this);
  }
}
