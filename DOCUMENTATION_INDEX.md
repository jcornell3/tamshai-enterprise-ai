...
### .specify/specs/
- `.specify/specs/001-foundation/plan.md`
- `.specify/specs/001-foundation/spec.md`
- `.specify/specs/001-foundation/tasks.md`
- `.specify/specs/002-security-layer/plan.md`
- `.specify/specs/002-security-layer/spec.md`
- `.specify/specs/002-security-layer/tasks.md`
...
- `.specify/specs/003-mcp-gateway/REFACTORING_REVIEW.md`
- `.specify/specs/003-mcp-gateway/REFACTORINGv2_PLAN.md`
- `.specify/specs/003-mcp-gateway/REFACTORINGv2_REVIEW.md`
...
- `.specify/specs/007-mobile/plan.md`
...
- `.specify/specs/011-qa-testing/plan.md`
- `.specify/specs/011-qa-testing/QA_TESTING_TECH_STACK.md`
- `.specify/specs/011-qa-testing/spec.md`
- `.specify/specs/011-qa-testing/tasks.md`
...
- `clients/desktop/SECURITY_UPDATE.md`
...
- `clients/web/apps/hr/README.md`
- `clients/web/apps/portal/README.md`
- `clients/web/DEPLOYMENT.md`
- `clients/web/DEPLOYMENT_COMPLETE.md`
- `clients/web/DEPLOYMENT_TEST_RESULTS.md`
- `clients/web/FINAL_DEPLOYMENT_STATUS.md`
...
- `docs/development/MOBILE_DEVELOPMENT_SUMMARY.md`
...
- `infrastructure/terraform/vps/SECRETS_MANAGEMENT.md`
...
| File | Description |
|------|-------------|
| `CHANGELOG.md` | Tracks all notable changes to the project following Keep a Changelog format and semantic versioning. |
...
| File | Description |
|------|-------------|
| `.claude/instructions.md` | Custom instructions for Claude Code defining Flutter/Dart expertise and enterprise development patterns. |

### .github/

| File | Description |
|------|-------------|
| `.github/PULL_REQUEST_TEMPLATE.md` | Template for creating consistent pull requests with summary, test plan, and checklist sections. |
| `.github/templates/plan-template.md` | Template for creating implementation plans within the Spec Kit framework. |
| `.github/templates/spec-template.md` | Template for creating feature specifications with business intent and security requirements. |
| `.github/templates/tasks-template.md` | Template for breaking down specifications into actionable development tasks. |
...
| File | Description |
|------|-------------|
| `clients/desktop/ELECTRON_SINGLE_INSTANCE_LOCK_INVESTIGATION.md` | Investigation of Windows race condition bug in Electron single-instance lock. |
| `clients/desktop/IMPLEMENTATION_STATUS.md` | Current implementation status of the Electron desktop client. |
| `clients/desktop/OAUTH_DEBUG_STATUS.md` | Debug status and troubleshooting notes for OAuth authentication issues. |
| `clients/desktop/README.md` | Documentation for the Electron/React cross-platform desktop client. |
| `clients/desktop/SECURITY_UPDATE.md` | Security updates and vulnerability fixes applied to the desktop client. |
...
| File | Description |
|------|-------------|
| `docs/architecture/constitution.md` | Project constitution defining security mandates, MCP standards, and development rules. |
| `docs/architecture/diagrams/v1.4-confirmation-flow.md` | Diagram and explanation of the v1.4 human-in-the-loop confirmation flow. |
...
| File | Description |
|------|-------------|
| `docs/compliance/data-processing-register.md` | GDPR Article 30 compliant data processing activities register. |
...
| File | Description |
|------|-------------|
| `keycloak/README.md` | Documentation for Keycloak realm configuration files and test users. |
...
| File | Description |
|------|-------------|
| `tests/integration/README.md` | Documentation for integration tests covering RBAC and all 19 MCP tools. |
| `tests/INTEGRATION_TEST_SUMMARY.md` | Summary of integration test coverage and results. |
| `tests/performance/README.md` | Documentation for k6 performance and load tests with TDD approach. |
