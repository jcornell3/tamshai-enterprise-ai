...
### 4. Integration Tests - Realm Import Failures
...
1. ✅ **Wait for current CI run** to complete with new realm setup
2. ⏭️ **Update integration test setup scripts** (if needed) to create users via API
3. ⏭️ **Fix Terraform credentials** in deploy.yml (optional - only for deployments)
