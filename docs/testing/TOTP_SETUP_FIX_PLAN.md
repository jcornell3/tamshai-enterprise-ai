...
reset_test_user_password() {
    ...
    if [[ "$HTTP_CODE" == "204" ]]; then
        log_success "Password reset to: Test123!Journey"
    else
...
- Ensures test-user.journey always has "Test123!Journey" password
...
3. Verify:
   - test-user.journey can authenticate with "Test123!Journey"
...
- ✅ test-user.journey password is "Test123!Journey" after realm recreation
...
```bash
python reset-test-user-password.py <admin-password> Test123!Journey
```
