...
|----------|----------|-------------|-------|--------|
| eve.thompson | password123 | JBSWY3DPEHPK3PXP | executive | All apps (CEO) |
...
| carol.johnson | password123 | JBSWY3DPEHPK3PXP | sales-read, sales-write | Sales app |
| dan.williams | password123 | JBSWY3DPEHPK3PXP | support-read, support-write | Support app |
| nina.patel | password123 | JBSWY3DPEHPK3PXP | manager | Team-level access |
| marcus.johnson | password123 | JBSWY3DPEHPK3PXP | user | Self-service only |
| frank.davis | password123 | JBSWY3DPEHPK3PXP | intern | Minimal access |
...
If using the default TOTP secret `JBSWY3DPEHPK3PXP`:
...
All have password `password123` and TOTP secret `JBSWY3DPEHPK3PXP`.
